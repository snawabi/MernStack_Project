...
import { saveProduct } from "../../State/ProductState/ProductActions"; 

let SaveProductComponent = () => {
  ...
  let defaultProd = useSelector((state)=>state.productReducer.defaultProduct)//mapStateToProps, making subsriber
    ...
    let saveProductClick = (evt)=>{
        ...
        console.log("in file productComponent.js dispatchToSave(saveProduct(productToBeSaved))")
